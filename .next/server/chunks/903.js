...
/* harmony import */ var gamba_react_v2__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6545);
/* harmony import */ var gamba_react_v2__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(gamba_react_v2__WEBPACK_IMPORTED_MODULE_4__);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_solana_wallet_adapter_react__WEBPACK_IMPORTED_MODULE_5__, _solana_wallet_adapter_react_ui__WEBPACK_IMPORTED_MODULE_6__]);
([_solana_wallet_adapter_react__WEBPACK_IMPORTED_MODULE_5__, _solana_wallet_adapter_react_ui__WEBPACK_IMPORTED_MODULE_6__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function usePlinko(props, deps) {
    const [plinko, set] = react__WEBPACK_IMPORTED_MODULE_3___default().useState(null);
...
function Plinko() {
    ...
    const gamba = (0,gamba_react_v2__WEBPACK_IMPORTED_MODULE_4__.useGamba)();
    const [wager, setWager] = (0,gamba_react_ui_v2__WEBPACK_IMPORTED_MODULE_1__.useWagerInput)();
    const [debug, setDebug] = react__WEBPACK_IMPORTED_MODULE_3___default().useState(false);
    const [degen, setDegen] = react__WEBPACK_IMPORTED_MODULE_3___default().useState(false);
    ...
    const pegAnimations = react__WEBPACK_IMPORTED_MODULE_3___default().useRef({});
    const bucketAnimations = react__WEBPACK_IMPORTED_MODULE_3___default().useRef({});
    const bet = degen ? DEGEN_BET : BET;
    const rows = degen ? 12 : 14;
    const multipliers = react__WEBPACK_IMPORTED_MODULE_3___default().useMemo(()=>Array.from(new Set(bet)), [
        bet
    ]);
