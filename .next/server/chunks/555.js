...
/* harmony import */ var _Slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8804);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_solana_wallet_adapter_react__WEBPACK_IMPORTED_MODULE_7__, _solana_wallet_adapter_react_ui__WEBPACK_IMPORTED_MODULE_8__]);
([_solana_wallet_adapter_react__WEBPACK_IMPORTED_MODULE_7__, _solana_wallet_adapter_react_ui__WEBPACK_IMPORTED_MODULE_8__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
const outcomes = (length, multiplierCallback)=>{
    ...
    return payoutArray.map((x)=>Number(BigInt(x * gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__.BPS_PER_WHOLE) / BigInt(totalValue || 1) * BigInt(length)) / gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__.BPS_PER_WHOLE);
};
function Dice() {
    ...
    const [resultIndex, setResultIndex] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(-1);
    const [rollUnderIndex, setRollUnderIndex] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(Math.floor(DICE_SIDES / 2));
    ...
    const multiplier = Number(BigInt(DICE_SIDES * gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__.BPS_PER_WHOLE) / BigInt(rollUnderIndex)) / gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__.BPS_PER_WHOLE;
    const bet = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(()=>outcomes(DICE_SIDES, (resultIndex)=>{
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Slider__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
