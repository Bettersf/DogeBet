...
/* harmony import */ var gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4442);
/* harmony import */ var gamba_core_v2__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__);
...
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_solana_wallet_adapter_react__WEBPACK_IMPORTED_MODULE_6__, _solana_wallet_adapter_react_ui__WEBPACK_IMPORTED_MODULE_7__]);
([_solana_wallet_adapter_react__WEBPACK_IMPORTED_MODULE_6__, _solana_wallet_adapter_react_ui__WEBPACK_IMPORTED_MODULE_7__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
...
function Mines() {
    ...
    const gamba = (0,gamba_react_v2__WEBPACK_IMPORTED_MODULE_5__.useGamba)();
    ...
    const [grid, setGrid] = react__WEBPACK_IMPORTED_MODULE_4___default().useState((0,_utils__WEBPACK_IMPORTED_MODULE_9__/* .generateGrid */ .k_)(_constants__WEBPACK_IMPORTED_MODULE_8__/* .GRID_SIZE */ .k));
    const [currentLevel, setLevel] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(0);
    const [selected, setSelected] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(-1);
    const [totalGain, setTotalGain] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(0);
    const [loading, setLoading] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(false);
    const [started, setStarted] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(false);
    const [initialWager, setInitialWager] = (0,gamba_react_ui_v2__WEBPACK_IMPORTED_MODULE_2__.useWagerInput)();
    const [mines, setMines] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(_constants__WEBPACK_IMPORTED_MODULE_8__/* .MINE_SELECT[2] */ .SG[2]);
    const getMultiplierForLevel = (level)=>{
        const remainingCells = _constants__WEBPACK_IMPORTED_MODULE_8__/* .GRID_SIZE */ .k - level;
        return Number(BigInt(remainingCells * gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__.BPS_PER_WHOLE) / BigInt(remainingCells - mines)) / gamba_core_v2__WEBPACK_IMPORTED_MODULE_3__.BPS_PER_WHOLE;
    };
    const levels = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(()=>{
        ...
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(gamba_react_ui_v2__WEBPACK_IMPORTED_MODULE_2__.GambaUi.Portal, {
                ...
                children: !started ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                    ...
                    onClick: endGame,
                    children: totalGain > 0 ? "Finish" : "Reset"
                })
            })
        ]
    });
