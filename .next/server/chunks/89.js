...
function HiLo(props) {
    ...
    const [cards, setCards] = react__WEBPACK_IMPORTED_MODULE_4___default().useState([
        card()
    ]);
    const [claiming, setClaiming] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(false);
    const [initialWager, setInitialWager] = (0,gamba_react_ui_v2__WEBPACK_IMPORTED_MODULE_2__.useWagerInput)();
    const [profit, setProfit] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(0);
    const currentRank = cards[cards.length - 1].rank;
    const [option, setOption] = react__WEBPACK_IMPORTED_MODULE_4___default().useState(currentRank > _constants__WEBPACK_IMPORTED_MODULE_3__/* .RANKS */ .Wz / 2 ? "lo" : "hi");
    const [hoveredOption, hoverOption] = react__WEBPACK_IMPORTED_MODULE_4___default().useState();
    ...
    const betHi = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(()=>generateBetArray(currentRank, true), [
        currentRank
    ]);
    const betLo = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(()=>generateBetArray(currentRank, false), [
        currentRank
    ]);
    const _bet = react__WEBPACK_IMPORTED_MODULE_4___default().useMemo(()=>{
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(gamba_react_ui_v2__WEBPACK_IMPORTED_MODULE_2__.GambaUi.Portal, {
                ...
                children: !profit ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                    children: [
                        ...
                        initialWager > maxWagerForBet && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(gamba_react_ui_v2__WEBPACK_IMPORTED_MODULE_2__.GambaUi.Button, {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(gamba_react_ui_v2__WEBPACK_IMPORTED_MODULE_2__.GambaUi.PlayButton, {
                            disabled: !option,
                            onClick: play,
                            children: "Deal card"
                        })
