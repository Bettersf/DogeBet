...
export function WelcomeBanner() {
  ...
  <div className="whitespace-nowrap grid grid-cols-2 grid-rows-2 gap-2 mt-5 md:flex md:flex-col md:mt-0 md:justify-start">
    <button
      ...
      className="rounded-lg p-3 bg-gray-800 bg-opacity-75 hover:bg-black-900 hover:-translate-y-0.5 transform text-white font-bold transition-all duration-200 ease-in-out cursor-pointer shadow-lg hover:shadow-xl"
    >
      Buy $GEOG
    </button>
    <button
